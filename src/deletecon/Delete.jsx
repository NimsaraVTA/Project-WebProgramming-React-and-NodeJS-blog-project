        ...
        <>
            ...
            <div className="delete">
                ...
                <div class="container">
                    ...
                    <h1 className="contactTitle">Update Contact Here</h1>
                    <br />
                    <form action="/action_page.php">
                        ...
                        <div class="row">
                            <Link to="/showcon" style={{ textDecoration: "none", color: "inherit" }}><input type="submit" className="btn btn-primary adCon" value="Update Contact" /></Link>
